...
class Note: ObservableObject, Identifiable, Codable, Equatable {
    ...
    ///Conforming to equatable through id (UUID)
...
@MainActor class Notes: ObservableObject, Identifiable {
    ...
    ///Deletes a given note and saves to UserDefaults
    ...
    ///A getter for the title of a note
    func getTitle(_ note: Note) -> String {
        return note.title
    }
    ...
    ///A getter for the favorties status of a note
    func getFavorites(_ note: Note) -> Bool {
