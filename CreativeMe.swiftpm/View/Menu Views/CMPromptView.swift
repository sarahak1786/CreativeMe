...
struct CMPromptView: View {
    ...
    ///Variables for orientation, color scheme, and dismisser
...
struct CMPromptGenerator: View {
    ...
    ///Variables for selection type and prompt directions
    ...
    ///Gets a random prompt based on user selection of NoteType
    func getPrompt() {
        if type == "Poem" {
