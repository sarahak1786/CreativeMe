...
struct CMHomeView: View {
    ...
    ///Variables for orientation, color scheme, intializing user data, and startup view
    ...
    var body: some View {
        ZStack {
                ...
                GeometryReader { geo in
                    ...
                    if horizontalSize == .regular && verticalSize == .regular && orientationInfo.orientation == .portrait {
                        Image(colorScheme == .dark ? "CreativeMeDark" : "CreativeMeLogo")
                            ...
                            .accessibilityLabel("Creative me logo")
            ...
            ///Environment object for device orientation
            .environmentObject(OrientationInfo())
        }
        ///Environment object for all user notes
        .environmentObject(allNotes)
        
        ///Presents welcome view for first time users
        .fullScreenCover(isPresented: $firstRun) {
            CMWelcomeView(firstRun: $firstRun)
        }
    }
}
...
struct CMNoteView: View {
    ...
    var body: some View {
                    ...
                    if horizontalSize == .regular && verticalSize == .regular && orientationInfo.orientation == .portrait {
                        ZStack {
                            ...
                            VStack(alignment: .leading) {
                                ...
                                .accessibilityElement(children: .ignore)
                                .accessibilityLabel("\(filteredNotes[index].title) of type \(convertTypeToString(filteredNotes[index]))")
                                .padding()
                                ...
                                HStack {
                                    ...
                                    .padding()
                                    .accessibilityLabel("Tap to view this note")
                                    ...
                                    Text(convertDatetoString(filteredNotes[index]))
                                        ...
                                        .fontWeight(.thin)
                                        .padding()
                                        .accessibilityLabel("This note was created on \(convertDatetoString(filteredNotes[index]))")
                                }
                                .padding()
                            }
                            .padding(30)
                ...
                VStack {
                    Menu {
                        ...
                        Label("", systemImage: "ellipsis.circle")
                            ...
                            .foregroundColor(.white)
                            .frame(width: 80, height: 30)
                            .accessibilityLabel("Tap to choose from filter options")
                    }
                }
                .offset(x: 230, y: -180)
        ...
        ///Updates index to current index for filter
        .onAppear {
                ...
                VStack {
                    Button() {
                        ...
                        Image(systemName: "line.3.horizontal.circle.fill")
                            ...
                            .colorScheme(.light)
                            .padding(.top)
                            .accessibilityLabel("View welcome screen")
                    }
                    ...
                    Button() {
                        ...
                        Image(systemName: "graduationcap.circle.fill")
                            ...
                            .colorScheme(.light)
                            .accessibilityLabel("View tutorial screen")
                    }
                    ...
                    Button() {
                        ...
                        Image(systemName: "square.and.pencil.circle.fill")
                            ...
                            .colorScheme(.light)
                            .accessibilityLabel("View prompt generator screen")
                    }
                    ...
                    Button() {
                        ...
                        Image(systemName: "info.circle.fill")
                            ...
                            .colorScheme(.light)
                            .padding()
                            .accessibilityLabel("View about screen")
                    }
                }
            }
...
struct CMHomeView_Previews: PreviewProvider {
    static var previews: some View {
        CMHomeView(firstRun: .constant(true))
            .environmentObject(OrientationInfo())
