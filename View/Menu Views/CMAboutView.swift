        ...
        ZStack {
            ...
            if (UIScreen.main.bounds.height >= 1194 && UIScreen.main.bounds.height <= 2732) && orientation.isPortrait {
                    ...
                    GeometryReader { geo in
                        ...
                        .position(x: geo.frame(in: .local).minX + geo.size.width * 0.24, y: geo.frame(in: .local).minY + geo.size.height * 0.18)
                    }
                ...
                ///Optimized for iPad Pro Landscape
                    ...
                    GeometryReader { geo in
                        ...
                        .position(x: geo.frame(in: .local).minX + geo.size.width * 0.5, y: geo.frame(in: .local).minY + geo.size.height * 0.18)
                    }
